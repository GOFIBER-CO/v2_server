...
const AppRouter: React.FC = () => {
    ...
    const adminRouter = [
        ...
        />,
        <Route path="/manage-deposit-guide" element={<ManageDepositGuide />} />,
        ...
        <Route path="/manage-order/:id" element={<EditOrder />} />,
        <Route path="/manage-ticket/:id" element={<EditTicket />} />,
        <Route path="/user-statistic" element={<UserStatistic />} />,
